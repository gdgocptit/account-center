defmodule AccountCenterWeb.UserLiveTest do
  use AccountCenterWeb.ConnCase

  import Phoenix.LiveViewTest
  import AccountCenter.AccountsFixtures

  @create_attrs %{name: "some name", email: "some email", password_digest: "some password_digest", deleted_at: "2025-02-11T08:32:00Z"}
  @update_attrs %{name: "some updated name", email: "some updated email", password_digest: "some updated password_digest", deleted_at: "2025-02-12T08:32:00Z"}
  @invalid_attrs %{name: nil, email: nil, password_digest: nil, deleted_at: nil}
